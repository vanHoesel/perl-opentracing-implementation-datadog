...
subtest 'Clone with resource_name' => sub {
...
#           trace_id      => 12345, # you can not assign to trace_id!
    ...
    lives_ok {
        $span_context_2 = $span_context_1->with_resource_name('rsrc 2');
    ...
    is $span_context_1->get_resource_name, 'rsrc 1',
        "... and the original SpanContext [1] has not changed";
    
    is $span_context_2->get_resource_name, 'rsrc 2',
        "... and the cloned SpanContext [2] has the expected values [rsrc 2]";

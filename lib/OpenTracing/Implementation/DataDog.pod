...
L<Devel::StrictMode> that uses the following set of environment vatiables:
...
When any of those are set, testst are run using type constraints and parameter
